                    ...
                    <div class="row">
                        <div class="col-md-12" style="border-bottom: black 5px solid;">
                            <div class="col-md-12" style=" margin: 5px;" >
                                ...
                                <h1>&nbsp&nbsp|ADMINS->CONSULTAR USUARIOS</h1>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="?c=pag&m=editarPerfil" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                                            <a href="?c=Admins&m=eliminar&id= <?php echo $r->id_usuarios?>" class="btn btn-primary btn-sm"><i class="fas fa-trash-alt"></i></a>
